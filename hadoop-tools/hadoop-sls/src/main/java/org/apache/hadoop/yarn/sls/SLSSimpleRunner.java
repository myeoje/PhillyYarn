...
public class SLSSimpleRunner {
    ...
    private static boolean simpleRMMode;
    ...
    public static boolean isSimpleRMMode()
    {
        return simpleRMMode;
    }
        ...
        for (String inputTrace : inputTraces) {
            ...
            try {
                ...
                while (i.hasNext()) {
                    ...
                    jobSubmitTime = jobSubmitTime / 1000 / 3 * 1000;
                    jobStartTime = jobStartTime / 1000 / 3 * 1000;
                    jobFinishTime = jobFinishTime / 1000 / 3 * 1000;
